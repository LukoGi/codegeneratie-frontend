<template>
  <div class="card mb-3">
    <div class="card-header">
      <p class="card-text"><strong>From Account:</strong> {{ transaction.from_account.iban }} ({{ transaction.from_account.accountType }})</p>
    </div>
    <div class="card-body">
      <h5 class="card-title">Transfer amount: € {{ formatCurrency(transaction.transfer_amount) }}</h5>
      <p class="card-text"><strong>To Account:</strong> {{ transaction.to_account.iban }} ({{ transaction.to_account.accountType }})</p>
